...
# Form implementation generated from reading ui file 'src/pyEtude.ui'
#
...
"}")
        ...
        self.soustitreGroupBox.setGeometry(QtCore.QRect(10, 80, 300, 61))
        self.soustitreGroupBox.setObjectName("soustitreGroupBox")
        self.soustitreLineEdit = QtWidgets.QLineEdit(self.soustitreGroupBox)
        self.soustitreLineEdit.setGeometry(QtCore.QRect(12, 25, 281, 29))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.matGroupBox.setGeometry(QtCore.QRect(100, 150, 140, 61))
        ...
        self.matLineEdit.setGeometry(QtCore.QRect(15, 25, 98, 29))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.matToolButton.setGeometry(QtCore.QRect(106, 25, 20, 29))
        ...
        self.numGroupBox.setGeometry(QtCore.QRect(100, 210, 140, 61))
        ...
        self.numLineEdit.setGeometry(QtCore.QRect(15, 25, 98, 29))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.numToolButton.setGeometry(QtCore.QRect(106, 25, 21, 29))
        ...
        self.sectionGroupBox.setGeometry(QtCore.QRect(10, 290, 300, 61))
        ...
        self.sectionLineEdit.setGeometry(QtCore.QRect(40, 25, 251, 29))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(340, 390, 331, 51))
        ...
        self.modelGroupBox = QtWidgets.QGroupBox(self.genTab)
        self.modelGroupBox.setGeometry(QtCore.QRect(10, 365, 321, 71))
        self.modelGroupBox.setObjectName("modelGroupBox")
        self.modelLineEdit = QtWidgets.QLineEdit(self.modelGroupBox)
        self.modelLineEdit.setEnabled(False)
        self.modelLineEdit.setGeometry(QtCore.QRect(27, 30, 251, 29))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.modelLineEdit.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.modelToolButton = QtWidgets.QPushButton(self.modelGroupBox)
        self.modelToolButton.setGeometry(QtCore.QRect(270, 30, 21, 29))
        self.modelToolButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.modelListWidget = QtWidgets.QListWidget(self.modelTab)
        self.modelListWidget.setGeometry(QtCore.QRect(20, 20, 181, 341))
        self.modelListWidget.setStyleSheet("QListView::item{\n"
"  padding-top: 10px;\n"
"  padding-bottom:10px;\n"
"  border-radius: 4px;\n"
"  margin-top: 10px;\n"
...
"  border-color: #969696;\n"
"}")
        self.modelListWidget.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.modelListWidget.setDefaultDropAction(QtCore.Qt.CopyAction)
        self.modelListWidget.setAlternatingRowColors(False)
        self.modelListWidget.setMovement(QtWidgets.QListView.Static)
        self.modelListWidget.setBatchSize(100)
        self.modelListWidget.setObjectName("modelListWidget")
        self.modelListPlus = QtWidgets.QPushButton(self.modelTab)
        self.modelListPlus.setEnabled(True)
        self.modelListPlus.setGeometry(QtCore.QRect(20, 370, 21, 21))
        self.modelListPlus.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.modelListPlus.setObjectName("modelListPlus")
        self.modelListMinus = QtWidgets.QPushButton(self.modelTab)
        self.modelListMinus.setEnabled(False)
        self.modelListMinus.setGeometry(QtCore.QRect(47, 370, 21, 21))
        self.modelListMinus.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.modelListMinus.setObjectName("modelListMinus")
        self.modelWikiLink = QtWidgets.QLabel(self.modelTab)
        self.modelWikiLink.setGeometry(QtCore.QRect(16, 409, 280, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.modelWikiLink.setFont(font)
        self.modelWikiLink.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.modelWikiLink.setTextFormat(QtCore.Qt.RichText)
        self.modelWikiLink.setOpenExternalLinks(True)
        self.modelWikiLink.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse)
        self.modelWikiLink.setObjectName("modelWikiLink")
        self.modelListReset = QtWidgets.QPushButton(self.modelTab)
        self.modelListReset.setEnabled(True)
        self.modelListReset.setGeometry(QtCore.QRect(126, 370, 75, 21))
        self.modelListReset.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.modelListReset.setObjectName("modelListReset")
        self.modelValuesGroupBox = QtWidgets.QGroupBox(self.modelTab)
        self.modelValuesGroupBox.setEnabled(False)
        self.modelValuesGroupBox.setGeometry(QtCore.QRect(220, 5, 451, 237))
        self.modelValuesGroupBox.setObjectName("modelValuesGroupBox")
        self.formLayoutWidget_2 = QtWidgets.QWidget(self.modelValuesGroupBox)
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(10, 30, 431, 201))
        self.formLayoutWidget_2.setObjectName("formLayoutWidget_2")
        self.modelValuesFormLayout = QtWidgets.QFormLayout(self.formLayoutWidget_2)
        self.modelValuesFormLayout.setContentsMargins(0, 0, 0, 0)
        self.modelValuesFormLayout.setObjectName("modelValuesFormLayout")
        self.titreModelLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.titreModelLineEdit.setObjectName("titreModelLineEdit")
        self.modelValuesFormLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.titreModelLineEdit)
        self.soustitreModelLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.soustitreModelLineEdit.setObjectName("soustitreModelLineEdit")
        self.modelValuesFormLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.soustitreModelLineEdit)
        self.matiereModelLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.matiereModelLineEdit.setObjectName("matiereModelLineEdit")
        self.modelValuesFormLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.matiereModelLineEdit)
        self.numeroModelLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.numeroModelLineEdit.setObjectName("numeroModelLineEdit")
        self.modelValuesFormLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.numeroModelLineEdit)
        self.sectionModelLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.sectionModelLineEdit.setObjectName("sectionModelLineEdit")
        self.modelValuesFormLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.sectionModelLineEdit)
        self.auteurModelLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.auteurModelLineEdit.setObjectName("auteurModelLineEdit")
        self.modelValuesFormLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.auteurModelLineEdit)
        self.titreModelCheckBox = QtWidgets.QCheckBox(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.titreModelCheckBox.setFont(font)
        self.titreModelCheckBox.setChecked(True)
        self.titreModelCheckBox.setObjectName("titreModelCheckBox")
        self.modelValuesFormLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.titreModelCheckBox)
        self.soustitreModelCheckBox = QtWidgets.QCheckBox(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.soustitreModelCheckBox.setFont(font)
        self.soustitreModelCheckBox.setChecked(True)
        self.soustitreModelCheckBox.setObjectName("soustitreModelCheckBox")
        self.modelValuesFormLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.soustitreModelCheckBox)
        self.matiereModelCheckBox = QtWidgets.QCheckBox(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.matiereModelCheckBox.setFont(font)
        self.matiereModelCheckBox.setChecked(True)
        self.matiereModelCheckBox.setObjectName("matiereModelCheckBox")
        self.modelValuesFormLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.matiereModelCheckBox)
        self.numeroModelCheckBox = QtWidgets.QCheckBox(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.numeroModelCheckBox.setFont(font)
        self.numeroModelCheckBox.setChecked(True)
        self.numeroModelCheckBox.setObjectName("numeroModelCheckBox")
        self.modelValuesFormLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.numeroModelCheckBox)
        self.sectionModelCheckBox = QtWidgets.QCheckBox(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.sectionModelCheckBox.setFont(font)
        self.sectionModelCheckBox.setChecked(True)
        self.sectionModelCheckBox.setObjectName("sectionModelCheckBox")
        self.modelValuesFormLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.sectionModelCheckBox)
        self.auteurModelCheckBox = QtWidgets.QCheckBox(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.auteurModelCheckBox.setFont(font)
        self.auteurModelCheckBox.setChecked(True)
        self.auteurModelCheckBox.setObjectName("auteurModelCheckBox")
        self.modelValuesFormLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.auteurModelCheckBox)
        self.niveauModelCheckBox = QtWidgets.QCheckBox(self.formLayoutWidget_2)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.niveauModelCheckBox.setFont(font)
        self.niveauModelCheckBox.setStyleSheet("")
        self.niveauModelCheckBox.setChecked(True)
        self.niveauModelCheckBox.setObjectName("niveauModelCheckBox")
        self.modelValuesFormLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.niveauModelCheckBox)
        self.niveauModelLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.niveauModelLineEdit.setEnabled(False)
        self.niveauModelLineEdit.setObjectName("niveauModelLineEdit")
        self.modelValuesFormLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.niveauModelLineEdit)
        self.modelPathsGroupBox = QtWidgets.QGroupBox(self.modelTab)
        self.modelPathsGroupBox.setEnabled(False)
        self.modelPathsGroupBox.setGeometry(QtCore.QRect(220, 240, 451, 121))
        self.modelPathsGroupBox.setStyleSheet("")
        self.modelPathsGroupBox.setObjectName("modelPathsGroupBox")
        self.formLayoutWidget = QtWidgets.QWidget(self.modelPathsGroupBox)
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 30, 431, 81))
        self.formLayoutWidget.setObjectName("formLayoutWidget")
        self.modelPathsLayout = QtWidgets.QFormLayout(self.formLayoutWidget)
        self.modelPathsLayout.setFormAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.modelPathsLayout.setContentsMargins(0, 0, 0, 0)
        self.modelPathsLayout.setObjectName("modelPathsLayout")
        self.modelDestinationLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.modelDestinationLabel.setObjectName("modelDestinationLabel")
        self.modelPathsLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.modelDestinationLabel)
        self.modelDestinationLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.modelDestinationLineEdit.setObjectName("modelDestinationLineEdit")
        self.modelPathsLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.modelDestinationLineEdit)
        self.modelPathModelLabel = QtWidgets.QLabel(self.formLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.modelPathModelLabel.setFont(font)
        self.modelPathModelLabel.setAlignment(QtCore.Qt.AlignJustify|QtCore.Qt.AlignVCenter)
        self.modelPathModelLabel.setWordWrap(True)
        self.modelPathModelLabel.setObjectName("modelPathModelLabel")
        self.modelPathsLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.modelPathModelLabel)
        self.modelPathPushButton = QtWidgets.QPushButton(self.formLayoutWidget)
        self.modelPathPushButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.modelPathPushButton.setStyleSheet("QPushButton {\n"
"    background-color: none;\n"
"    border: none;\n"
"    color: #FFFFFF;\n"
"    border-radius: 4px;\n"
...
"    border: none;\n"
"}")
        self.modelPathPushButton.setObjectName("modelPathPushButton")
        self.modelPathsLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.modelPathPushButton)
        self.modelDefaultPushButton = QtWidgets.QPushButton(self.modelTab)
        self.modelDefaultPushButton.setEnabled(False)
        self.modelDefaultPushButton.setGeometry(QtCore.QRect(220, 370, 111, 21))
        self.modelDefaultPushButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.modelDefaultPushButton.setObjectName("modelDefaultPushButton")
        self.modelApplyPushButton = QtWidgets.QPushButton(self.modelTab)
        self.modelApplyPushButton.setEnabled(True)
        self.modelApplyPushButton.setGeometry(QtCore.QRect(470, 370, 201, 61))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.modelApplyPushButton.setFont(font)
        self.modelApplyPushButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.modelApplyPushButton.setObjectName("modelApplyPushButton")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.modelGroupBox.setTitle(_translate("MainWindow", "Modèle"))
        ...
        self.modelListPlus.setText(_translate("MainWindow", "+"))
        self.modelListMinus.setText(_translate("MainWindow", "-"))
        self.modelWikiLink.setText(_translate("MainWindow", "<html><head/><body><p><a href=\"https://github.com/BourgonLaurent/pyEtude/wiki/Comment-cr%C3%A9er-son-propre-mod%C3%A8le\"><span style=\" text-decoration: underline; color:#f0f0f0;\">Comment créer vos propres modèles?</span></a></p></body></html>"))
        self.modelListReset.setText(_translate("MainWindow", "Réinitialiser"))
        self.modelValuesGroupBox.setTitle(_translate("MainWindow", "Valeurs"))
        self.titreModelLineEdit.setPlaceholderText(_translate("MainWindow", "Titre"))
        self.soustitreModelLineEdit.setPlaceholderText(_translate("MainWindow", "Sous-Titre"))
        self.matiereModelLineEdit.setPlaceholderText(_translate("MainWindow", "Matière"))
        self.numeroModelLineEdit.setPlaceholderText(_translate("MainWindow", "Numéro"))
        self.sectionModelLineEdit.setPlaceholderText(_translate("MainWindow", "Section"))
        self.auteurModelLineEdit.setPlaceholderText(_translate("MainWindow", "Auteur"))
        self.titreModelCheckBox.setText(_translate("MainWindow", "titre"))
        self.soustitreModelCheckBox.setText(_translate("MainWindow", "soustitre"))
        self.matiereModelCheckBox.setText(_translate("MainWindow", "matiere"))
        self.numeroModelCheckBox.setText(_translate("MainWindow", "numero"))
        self.sectionModelCheckBox.setText(_translate("MainWindow", "section"))
        self.auteurModelCheckBox.setText(_translate("MainWindow", "auteur"))
        self.niveauModelCheckBox.setText(_translate("MainWindow", "niveau"))
        self.niveauModelLineEdit.setPlaceholderText(_translate("MainWindow", "Niveau"))
        self.modelPathsGroupBox.setTitle(_translate("MainWindow", "Emplacements"))
        self.modelDestinationLabel.setText(_translate("MainWindow", "Dossier de destination"))
        self.modelPathModelLabel.setText(_translate("MainWindow", "Aucun fichier sélectionné"))
        self.modelPathPushButton.setText(_translate("MainWindow", "Fichier Modèle"))
        self.modelDefaultPushButton.setText(_translate("MainWindow", "Modèle par défaut"))
        self.modelApplyPushButton.setText(_translate("MainWindow", "Appliquer et Enregistrer"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.modelTab), _translate("MainWindow", "Modèles"))
        self.tabWidget.setTabToolTip(self.tabWidget.indexOf(self.modelTab), _translate("MainWindow", "Créer et gérer les modèles"))
